...
ActiveRecord::Schema.define(version: 2021_07_17_094141) do
  ...
  create_table "purchase_lists", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id", null: false
  ...
  create_table "shipping_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchase_list_id"], name: "index_shipping_addresses_on_purchase_list_id"
  end
  ...
  add_foreign_key "shipping_addresses", "purchase_lists"
end
